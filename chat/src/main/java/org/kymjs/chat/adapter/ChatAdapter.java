...
public class ChatAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View v, ViewGroup parent) {
        ...
        if (data.getType() == Message.MSG_TYPE_TEXT) {
            ...
            Log.v("ChatAdapter", data.getContent());
        ...
        if (listener != null) {
            ...
            holder.tv_chatcontent.setOnLongClickListener(new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View view) {
                    listener.onTextLongClick(position);
                    return true;
                }
            });
            /** 点击图片或者表情动画 */
            ...
            holder.img_sendfail.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    listener.onSendFailClick(position);
                }
            });
        }
     ...
     * 聊天列表中对内容的点击事件监听
     */
    public static interface OnChatItemClickListener {
        ...
        void onSendFailClick (int position);
    }
